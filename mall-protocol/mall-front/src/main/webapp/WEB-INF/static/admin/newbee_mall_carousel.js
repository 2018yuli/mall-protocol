$(function () {
    $("#jqGrid").jqGrid({
        url: getRootPath() + 'admin/carousels/list',
        datatype: "json",
        colModel: [
...
$('#saveButton').click(function () {
    ...
    var url = getRootPath() + 'admin/carousels/save';
    var id = getSelectedRowWithoutAlert();
    if (id != null) {
        url = getRootPath() + 'admin/carousels/update';
        data = {
            "carouselId": id,
            "carouselUrl": carouselUrl,
            "carouselRank": carouselRank,
...
function carouselEdit() {
    ...
    //请求数据
    $.get(getRootPath() + "admin/carousels/info/" + id, function (r) {
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: getRootPath() + "admin/carousels/delete",
                    contentType: "application/json",
