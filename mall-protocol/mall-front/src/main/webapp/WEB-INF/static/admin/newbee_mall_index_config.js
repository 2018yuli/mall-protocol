$(function () {
    ...
    $("#jqGrid").jqGrid({
        url: getRootPath() + 'admin/indexConfigs/list?configType=' + configType,
        datatype: "json",
        colModel: [
...
$('#saveButton').click(function () {
    ...
    if (!validCN_ENString2_18(configName)) {
        ...
        var url = getRootPath() + 'admin/indexConfigs/save';
        var id = getSelectedRowWithoutAlert();
        if (id != null) {
            url = getRootPath() + 'admin/indexConfigs/update';
            data = {
                "configId": id,
                "configName": configName,
                "configType": configType,
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: getRootPath() + "admin/indexConfigs/delete",
                    contentType: "application/json",
