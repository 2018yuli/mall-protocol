$(function () {
    $("#jqGrid").jqGrid({
        url: getRootPath() + 'admin/orders/list',
        datatype: "json",
        colModel: [
...
function openOrderItems(orderId) {
    ...
    $.ajax({
        type: 'GET',//方法类型
        url: getRootPath() + 'admin/order-items/' + orderId,
...
$('#saveButton').click(function () {
    ...
    var url = getRootPath() + 'admin/orders/update';
    var data = {
        "orderId": id,
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: getRootPath() + "admin/orders/checkDone",
                    contentType: "application/json",
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: getRootPath() + "admin/orders/checkOut",
                    contentType: "application/json",
                    data: JSON.stringify(ids),
                    success: function (r) {
                        if (r.resultCode == 200) {
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: getRootPath() + "admin/orders/close",
                    contentType: "application/json",
                    data: JSON.stringify(ids),
                    success: function (r) {
                        if (r.resultCode == 200) {
