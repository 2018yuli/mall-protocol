package com.ydual.mall.order.service.impl;
...
import com.ydual.mall.cart.dao.NewBeeMallShoppingCartItemMapper;
import com.ydual.mall.common.constants.NewBeeMallOrderStatusEnum;
import com.ydual.mall.common.constants.PayStatusEnum;
import com.ydual.mall.common.constants.PayTypeEnum;
import com.ydual.mall.common.constants.ServiceResultEnum;
import com.ydual.mall.common.exception.NewBeeMallException;
import com.ydual.mall.common.utils.MyBeanUtil;
import com.ydual.mall.common.utils.NumberUtil;
...
import com.ydual.mall.goodsmgr.dao.NewBeeMallGoodsMapper;
...
import com.ydual.mall.order.controller.vo.NewBeeMallOrderListVO;
import com.ydual.mall.order.dao.NewBeeMallOrderItemMapper;
import com.ydual.mall.order.dao.NewBeeMallOrderMapper;
import com.ydual.mall.order.entity.NewBeeMallOrder;
import com.ydual.mall.order.entity.NewBeeMallOrderItem;
...
public class NewBeeMallOrderServiceImpl implements NewBeeMallOrderService {
            ...
            if (newBeeMallShoppingCartItemMapper.deleteBatch(itemIdList) > 0) {
                ...
                if (newBeeMallOrderMapper.insertSelective(newBeeMallOrder) > 0) {
                    ...
                    for (NewBeeMallShoppingCartItemVO newBeeMallShoppingCartItemVO : myShoppingCartItems) {
                        ...
                        MyBeanUtil.copyProperties(newBeeMallShoppingCartItemVO, newBeeMallOrderItem);
    ...
    public NewBeeMallOrderDetailVO getOrderDetailByOrderNo(String orderNo, Long userId) {
        ...
        if (newBeeMallOrder != null) {
            ...
            if (!CollectionUtils.isEmpty(orderItems)) {
                List<NewBeeMallOrderItemVO> newBeeMallOrderItemVOS = MyBeanUtil.copyList(orderItems, NewBeeMallOrderItemVO.class);
                NewBeeMallOrderDetailVO newBeeMallOrderDetailVO = new NewBeeMallOrderDetailVO();
                MyBeanUtil.copyProperties(newBeeMallOrder, newBeeMallOrderDetailVO);
    ...
    public PageResult getMyOrders(PageQueryUtil pageUtil) {
        ...
        if (total > 0) {
            //数据转换 将实体类转成vo
            orderListVOS = MyBeanUtil.copyList(newBeeMallOrders, NewBeeMallOrderListVO.class);
            //设置订单状态中文显示值
            ...
            if (!CollectionUtils.isEmpty(orderIds)) {
                ...
                for (NewBeeMallOrderListVO newBeeMallOrderListVO : orderListVOS) {
                    ...
                    if (itemByOrderIdMap.containsKey(newBeeMallOrderListVO.getOrderId())) {
                        ...
                        List<NewBeeMallOrderItemVO> newBeeMallOrderItemVOS = MyBeanUtil.copyList(orderItemListTemp, NewBeeMallOrderItemVO.class);
