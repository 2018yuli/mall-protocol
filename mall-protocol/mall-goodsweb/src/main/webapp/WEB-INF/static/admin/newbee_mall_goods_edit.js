...
$('#saveButton').click(function () {
    ...
    var url = getRootPath() + 'admin/goods/save';
    var swlMessage = '保存成功';
    var data = {
        "goodsName": goodsName,
    ...
    if (goodsId > 0) {
        url = getRootPath() + 'admin/goods/update';
        swlMessage = '修改成功';
        data = {
            "goodsId": goodsId,
            "goodsName": goodsName,
        ...
        success: function (result) {
            if (result.resultCode == 200) {
                ...
                swal({
                    ...
                    window.location.href = getRootPath() + "admin/goods";
                })
            } else {
                $('#goodsModal').modal('hide');
                swal(result.message, {
...
$('#levelOne').on('change', function () {
    $.ajax({
        url: getRootPath() + 'admin/categories/listForSelect?categoryId=' + $(this).val(),
        type: 'GET',
        success: function (result) {
            if (result.resultCode == 200) {
                var levelTwoSelect = '';
