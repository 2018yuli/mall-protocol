$(function () {
    $("#jqGrid").jqGrid({
        url: getRootPath() + 'admin/goods/list',
        datatype: "json",
        colModel: [
 ...
 */
function addGoods() {
    window.location.href = getRootPath() + "admin/goods/edit";
}
...
function editGoods() {
    ...
    window.location.href = getRootPath() + "admin/goods/edit/" + id;
}
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "PUT",
                    url: getRootPath() + "admin/goods/status/0",
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "PUT",
                    url: getRootPath() + "admin/goods/status/1",
                    contentType: "application/json",
                    data: JSON.stringify(ids),
                    success: function (r) {
                        if (r.resultCode == 200) {
