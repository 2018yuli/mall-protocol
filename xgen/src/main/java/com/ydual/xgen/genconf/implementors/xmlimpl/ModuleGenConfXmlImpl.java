...
import com.ydual.xgen.genconf.implementors.dynamicparse.ParseContext;
...
public class ModuleGenConfXmlImpl implements ModuleGenConfImplementor {
	...
	private String[] parseValues(Context ctx) {
		...
		ReadXmlExpression re = Parser.parse(
				((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) (new ModuleGenConfBuilder())
						.addModuleGenConf().addSeparator()).addExtendConfs().addSeparator()).addExtendConf()
								.addDollar()).build());
	...
	private String[] parseIsSingles(Context ctx) {
		ctx.init();
		ReadXmlExpression re = Parser.parse(
				((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) (new ModuleGenConfBuilder())
						.addModuleGenConf().addSeparator()).addExtendConfs().addSeparator()).addExtendConf()
	...
	private String[] parseExtendIds(Context ctx) {
		ctx.init();
		ReadXmlExpression re = Parser.parse(
				((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) (new ModuleGenConfBuilder())
						.addModuleGenConf().addSeparator()).addExtendConfs().addSeparator()).addExtendConf()
	...
	private Context getContext(Map param) {
		Context c = null;
		try {
			String str = ((GenConfBuilder) ((GenConfBuilder) (new GenConfBuilder()).addXmlFilePre())
					.addOtherValue((String) param.get(ExpressionEnum.fileName.getExpr()))).build();
	...
	private void parseModuleId(ModuleConfModel mcm, Context c) {
		c.init();
		ReadXmlExpression re = Parser.parse(((ModuleGenConfBuilder) ((ModuleGenConfBuilder) (new ModuleGenConfBuilder())
				.addModuleGenConf().addDot()).addId()).build());
	...
	private Map parseNeedGenTypes(Context ctx) {
		...
		ReadXmlExpression re = Parser.parse(
				((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) (new ModuleGenConfBuilder())
						.addModuleGenConf().addSeparator()).addNeedGenTypes().addSeparator()).addNeedGenType()
								.addDollar()).addDot()).addId()).addDollar()).build());
	...
	private List parseNeedGenOutTypes(Context ctx, String needGenId) {
		...
		ReadXmlExpression re = Parser.parse(
				((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) ((ModuleGenConfBuilder) (new ModuleGenConfBuilder())
						.addModuleGenConf().addSeparator()).addNeedGenTypes().addSeparator()).addNeedGenType()
								.addDollar()).addOpenBracket()).addId()).addEqual()).addOtherValue(needGenId))
										.addCloseBracket()).addSeparator()).addNeedGenOutType().addDollar()).addDot())
