...
import com.ydual.mall.goodsmgr.controller.vo.NewBeeMallSearchGoodsVO;
import com.ydual.mall.goodsmgr.dao.NewBeeMallGoodsMapper;
import com.ydual.mall.goodsmgr.entity.NewBeeMallGoods;
import com.ydual.mall.goodsmgr.service.NewBeeMallGoodsService;
...
public class NewBeeMallGoodsServiceImpl implements NewBeeMallGoodsService {
    ...
    public PageResult searchNewBeeMallGoods(PageQueryUtil pageUtil) {
        ...
        if (!CollectionUtils.isEmpty(goodsList)) {
            newBeeMallSearchGoodsVOS = MyBeanUtil.copyList(goodsList, NewBeeMallSearchGoodsVO.class);
