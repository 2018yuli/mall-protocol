package com.ydual.mall.goodsmgr.service.impl;
...
import com.ydual.mall.common.constants.NewBeeMallCategoryLevelEnum;
...
import com.ydual.mall.goodsmgr.controller.vo.SecondLevelCategoryVO;
import com.ydual.mall.goodsmgr.controller.vo.ThirdLevelCategoryVO;
import com.ydual.mall.goodsmgr.dao.GoodsCategoryMapper;
            ...
            if (!CollectionUtils.isEmpty(secondLevelCategories)) {
                ...
                if (!CollectionUtils.isEmpty(thirdLevelCategories)) {
                    ...
                    for (GoodsCategory secondLevelCategory : secondLevelCategories) {
                        ...
                        MyBeanUtil.copyProperties(secondLevelCategory, secondLevelCategoryVO);
                        //如果该二级分类下有数据则放入 secondLevelCategoryVOS 对象中
                        if (thirdLevelCategoryMap.containsKey(secondLevelCategory.getCategoryId())) {
                            //根据二级分类的id取出thirdLevelCategoryMap分组中的三级分类list
                            List<GoodsCategory> tempGoodsCategories = thirdLevelCategoryMap.get(secondLevelCategory.getCategoryId());
                            secondLevelCategoryVO.setThirdLevelCategoryVOS((MyBeanUtil.copyList(tempGoodsCategories, ThirdLevelCategoryVO.class)));
                    ...
                    if (!CollectionUtils.isEmpty(secondLevelCategoryVOS)) {
                        ...
                        for (GoodsCategory firstCategory : firstLevelCategories) {
                            ...
                            MyBeanUtil.copyProperties(firstCategory, newBeeMallIndexCategoryVO);
